...
func _process(_delta: float) -> void:
	if CityResources.citizens >= 120 and CityResources.money >= 2500:
...
func _on_map_town_hall_built() -> void:
	...
	$GUI/M/V/H2/VBoxContainer/test_build2.show()
	$GUI/M/V/H2/VBoxContainer/test_build4.show()
	$GUI/M/V/H2/VBoxContainer/test_build5.show()
	$GUI/M/V/H2/VBoxContainer/test_build6.show()
	$GUI/M/V/H2/VBoxContainer/test_build7.show()
	$GUI/M/V/H2/VBoxContainer/test_build8.show()
