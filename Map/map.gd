...
func _on_day_timer_timeout() -> void:
	...
	$"../../GUI/M/V/Control/HBoxContainer/WaveProgressBar".start_progress_countdown("20.03.4038", date_str)
	spawn_wave_at("20.04.4038", date_str, 1.0)
	$"../../GUI/M/V/Control/HBoxContainer/WaveProgressBar".start_progress_countdown("27.05.4038", date_str)
	spawn_wave_at("27.06.4038", date_str, 1.3)
	$"../../GUI/M/V/Control/HBoxContainer/WaveProgressBar".start_progress_countdown("12.07.4038", date_str)
	spawn_wave_at("12.08.4038", date_str, 1.0)
	$"../../GUI/M/V/Control/HBoxContainer/WaveProgressBar".start_progress_countdown("30.09.4038", date_str)
	spawn_wave_at("30.10.4038", date_str, 1.7)
	$"../../GUI/M/V/Control/HBoxContainer/WaveProgressBar".start_progress_countdown("1.12.4038", date_str)
	spawn_wave_at("01.01.4039", date_str, 2.0)
	$"../../GUI/M/V/Control/HBoxContainer/WaveProgressBar".start_progress_countdown("10.03.4039", date_str)
	spawn_wave_at("10.04.4039", date_str, 1.7)
	$"../../GUI/M/V/Control/HBoxContainer/WaveProgressBar".start_progress_countdown("30.06.4039", date_str)
